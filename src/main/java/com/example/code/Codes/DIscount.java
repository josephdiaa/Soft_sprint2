    ...
    public void DiscountfirstRide(Client c,ArrayList<Offer> of){
        if(c.isFirstRide()){
            for(int i=0;i<of.size();i++){
                of.get(i).setDiscountedPrice(of.get(i).getPrice()-(of.get(i).getPrice()*0.1));
    ...
    public void DiscountNumPass(Request r1){
        if(r1.getNumPassenger()==2){
            for(int i=0;i<r1.getListOffer().size();i++){
                r1.getListOffer().get(i).setDiscountedPrice(r1.getListOffer().get(i).getPrice()-(r1.getListOffer().get(i).getPrice()*0.05));
                r1.getListOffer().get(i).setPrice(r1.getListOffer().get(i).getPrice()-(r1.getListOffer().get(i).getPrice()*0.1));
            }
        }
    }
